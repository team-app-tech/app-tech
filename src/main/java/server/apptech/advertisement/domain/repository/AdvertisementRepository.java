...
public interface AdvertisementRepository extends JpaRepository<Advertisement, Long> {
    ...
    //상금순
    @Query(value = "select a from Advertisement a join fetch a.user u where a.startDate >= :now and a.title like %:keyword% order by a.totalPrice DESC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where :now between a.startDate and a.endDate and a.title like %:keyword% order by a.totalPrice DESC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where a.endDate <= :now and a.title like %:keyword% order by a.totalPrice DESC ")
    ...
    //시작순
    @Query(value = "select a from Advertisement a join fetch a.user u where a.startDate >= :now and a.title like %:keyword% order by a.startDate ASC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where :now between a.startDate and a.endDate and a.title like %:keyword% order by a.startDate ASC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where a.endDate <= :now and a.title like %:keyword% order by a.startDate ASC ")
    ...
    //마감순
    @Query(value = "select a from Advertisement a join fetch a.user u where a.startDate >= :now and a.title like %:keyword% order by a.endDate ASC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where :now between a.startDate and a.endDate and a.title like %:keyword% order by a.endDate ASC ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where a.endDate <= :now and a.title like %:keyword% order by a.endDate ASC ")
    ...
    //조회순
    @Query(value = "select a from Advertisement a join fetch a.user u where a.startDate >= :now and a.title like %:keyword% order by a.viewCnt desc ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where :now between a.startDate and a.endDate and a.title like %:keyword% order by a.viewCnt desc ")
    ...
    @Query(value = "select a from Advertisement a join fetch a.user u where a.endDate <= :now and a.title like %:keyword% order by a.viewCnt desc ")
